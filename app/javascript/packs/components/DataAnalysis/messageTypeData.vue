      ...
      <div class="div-right">
        <table class="table">
          ...
          <tr v-model="firstCheck">
            ...
            <td v-model="messageTotal">{{((firstCheck[1] / totalWithBroad)*100).toFixed(2)}}%</td>
          </tr>
          <tr v-model="secondCheck">
            <td><i class="material-icons" id="second">looks_two</i>位</td>
            <td>{{secondCheck[0]}}</td>
            <td>{{secondCheck[1]}}件</td>
            <td v-model="messageTotal">{{((secondCheck[1] / totalWithBroad)*100).toFixed(2)}}%</td>
          </tr>
          <tr v-model="thirdCheck">
            <td><i class="material-icons" id="third">looks_3</i>位</td>
            <td>{{thirdCheck[0]}}</td>
            <td>{{thirdCheck[1]}}件</td>
            <td v-model="messageTotal">{{((thirdCheck[1] / totalWithBroad)*100).toFixed(2)}}%</td>
          </tr>
        </table>
      </div>
    </div>
