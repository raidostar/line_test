<template>
  <div class="in-panel">
    ...
    <div class="pie-chart">
      <div class="div-left">
        <pie-chart class="chart" :data="messageType" :colors="['#006400','#212529']" :donut="true" style="width: 542px;height:249px;"/>
      ...
      <div class="div-right">
        <table class="table">
          ...
          <tr v-model="secondType">
            <td><i class="material-icons ranking-mark" id="second">looks_two</i>位</td>
            <td>{{secondType[0]}}</td>
    ...
    <div class="pie-chart">
      <div class="div-left">
        <pie-chart class="chart" :data="checkStatus" :colors="['#007bff','#dc3545','#fd7e14','#28a745','#6f42c1']" :donut="true" style="width: 542px;height:249px;"/>
      ...
      <div class="div-right">
        <table class="table">
          ...
          <tr v-model="thirdCheck">
            <td><i class="material-icons ranking-mark" id="third">looks_3</i>位</td>
            <td>{{thirdCheck[0]}}</td>
...
<style scoped src="./personalPage.css"/>
